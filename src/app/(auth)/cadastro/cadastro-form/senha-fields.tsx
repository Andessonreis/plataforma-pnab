...
export function SenhaFields({ formData, updateField }: SenhaFieldsProps) {
  ...
  return (
    <>
      ...
      <Input
        ...
        autoComplete="new-password"
        rightIcon={
          <EyeToggle visible={showConfirmPassword} onClick={() => setShowConfirmPassword(!showConfirmPassword)} />
        }
      />
    </>
  )
