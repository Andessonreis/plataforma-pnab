      ...
      <article className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed">
            ...
            <li>
              Dados demográficos relevantes para os editais (autodeclaração
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed">
            <li>Informações do projeto cultural (descrição, cronograma, orçamento);</li>
            <li>Documentos comprobatórios (currículo, portfólio, certidões);</li>
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed">
            ...
            <li>Cookies essenciais e de desempenho (veja a seção específica).</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed">
            ...
            <li>
              Gestão de inscrições em editais de fomento à cultura;
            </li>
            <li>
              Análise de habilitação e avaliação de propostas culturais;
            </li>
            <li>
            ...
            <li>
              ...
              (publicação de dados não sensíveis do proponente e do projeto);
            </li>
            <li>
              Melhoria contínua dos serviços do portal por meio de
        ...
        <section className="mb-8">
          ...
          <p className="text-slate-600 leading-relaxed mb-4">
            O tratamento de dados pessoais realizado pelo Portal PNAB Irecê
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed">
            <li>
              ...
              executada pelo município, e o tratamento dos dados é necessário
            ...
            <li>
              ...
              (Art. 7, I) — Para dados não obrigatórios e cookies de
              desempenho, o consentimento do titular é solicitado de forma
              livre, informada e inequívoca;
            </li>
            <li>
              <strong className="text-slate-900">Interesse legítimo</strong>{' '}
              (Art. 7, IX) — Para fins estatísticos e de melhoria dos
              serviços, desde que resguardados os direitos fundamentais do
              titular.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed">
            <li>
              ...
              (CGU) e Ministério da Cultura, conforme exigências legais;
            </li>
            <li>
            ...
            <li>
              ...
              proponente, título do projeto e valor aprovado serão publicados
              nos resultados oficiais, conforme exigência de transparência
              ativa.
            </li>
          </ul>
          <p className="text-slate-600 leading-relaxed mt-4">
            ...
            não são transferidos para fora do território brasileiro.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-slate-600 leading-relaxed mb-4">
            ...
            perda, alteração ou vazamento, incluindo:
          </p>
          <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed">
            <li>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed">
            <li>
              ...
              Mantidos por no mínimo 10 (dez) anos, conforme exigência de
            ...
            <li>
              ...
              até 12 (doze) meses para fins estatísticos, sendo
              anonimizados após esse período;
            </li>
            <li>
              <strong className="text-slate-900">Dados para transparência pública</strong> —
              Mantidos por prazo indeterminado, conforme legislação de
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed">
            <li>
              <strong className="text-slate-900">Cookies essenciais</strong> — Necessários
            ...
            <li>
              ...
              para coletar estatísticas anônimas de uso. Requerem
        ...
        <section className="mt-12 rounded-xl bg-slate-50 border border-slate-200 p-6 sm:p-8">
          ...
          <p className="text-slate-600 leading-relaxed mb-4">
            Para questões relacionadas ao tratamento de dados pessoais,
            incluindo o exercício dos direitos do titular, entre em contato
          ...
          <p className="text-slate-600 leading-relaxed mt-4">
            O titular também poderá apresentar reclamação perante a
