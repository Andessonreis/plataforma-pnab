      ...
      <article className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-slate-600 leading-relaxed">
            ...
            (Libras). O widget do VLibras está disponível em todas as
            páginas públicas. Para utilizá-lo, clique no ícone do VLibras
          ...
          <p className="text-slate-600 leading-relaxed">
            Na barra superior do portal, estão disponíveis os botões
            &ldquo;A+&rdquo; e &ldquo;A-&rdquo; que permitem aumentar e
            diminuir o tamanho do texto para facilitar a leitura. Você
          ...
          <p className="text-slate-600 leading-relaxed">
            O botão &ldquo;Contraste&rdquo; na barra superior ativa o modo
            de alto contraste, melhorando a visibilidade do conteúdo para
            pessoas com baixa visão. Todo o texto do portal atende ao
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed mt-2">
            <li>
              <strong className="text-slate-900">Tab:</strong> Avança para o
          ...
          <p className="text-slate-600 leading-relaxed mt-4">
            ...
            visível para facilitar a identificação durante a
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed">
            ...
            <li>
              Formulários com rótulos associados e mensagens de erro claras;
            </li>
            <li>
              Áreas de toque com dimensão mínima de 44x44 pixels.
            </li>
          </ul>
        ...
        <section className="mb-8">
          ...
          <p className="text-slate-600 leading-relaxed mb-4">
            Este portal busca atender integralmente os seguintes padrões:
          </p>
          <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed">
            <li>
              <strong className="text-slate-900">WCAG 2.1 nível AA</strong>{' '}
            ...
            <li>
              ...
              — Modelo de Acessibilidade em Governo Eletrônico, padrão do
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed">
            <li>
              ...
              acessíveis — disponibilizamos versões alternativas em HTML
              sempre que possível;
            </li>
            <li>
              Conteúdos de terceiros (como widgets externos) podem não
              atender integralmente aos padrões de acessibilidade;
            </li>
            <li>
        ...
        <section className="mt-12 rounded-xl bg-slate-50 border border-slate-200 p-6 sm:p-8">
          ...
          <p className="text-slate-600 leading-relaxed mb-4">
            ...
            ou tiver sugestões de melhoria, entre em contato conosco.
            Valorizamos seu retorno e estamos comprometidos em resolver
            qualquer problema de acessibilidade no menor prazo possível.
          </p>
          ...
          <p className="text-slate-600 leading-relaxed mt-4">
            ...
            responder em até 5 (cinco) dias úteis.
          </p>
        </section>
