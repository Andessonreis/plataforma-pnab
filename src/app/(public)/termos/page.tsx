      ...
      <article className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-slate-600 leading-relaxed mt-4">
            ...
            estabelecidas, recomendamos que não utilize os serviços
            disponibilizados.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed">
            <li>
              Publicação e consulta de editais de fomento à cultura no âmbito
              da Política Nacional Aldir Blanc;
            </li>
            <li>
              Cadastro de proponentes (pessoas físicas, jurídicas e coletivos
              culturais) para submissão de projetos;
            </li>
            <li>
              Inscrição, acompanhamento e gestão de propostas culturais;
            </li>
            <li>
              Divulgação de resultados, habilitações e recursos;
            </li>
            <li>
          ...
          <p className="text-slate-600 leading-relaxed mt-4">
            O usuário compromete-se a utilizar o portal de forma lícita,
            respeitando a legislação vigente, a moral, os bons costumes e a
        ...
        <section className="mb-8">
          ...
          <p className="text-slate-600 leading-relaxed mb-4">
            ...
            projetos em editais), o usuário deverá criar uma conta
            fornecendo informações verdadeiras e atualizadas, incluindo CPF ou
            CNPJ conforme aplicável.
          </p>
          <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed">
            <li>
              O usuário é responsável pela veracidade de todas as informações
              fornecidas no cadastro e nas inscrições;
            </li>
            <li>
              A senha de acesso é pessoal e intransferível, cabendo ao usuário
              sua guarda e sigilo;
            </li>
            <li>
              A Secretaria poderá suspender ou cancelar contas que apresentem
              informações falsas, incompletas ou que violem estes Termos;
            </li>
            <li>
              O usuário deve comunicar imediatamente qualquer uso não
        ...
        <section className="mb-8">
          ...
          <p className="text-slate-600 leading-relaxed mb-4">
            ...
            visuais — é de propriedade da Prefeitura Municipal de Irecê ou
            de seus respectivos titulares, sendo protegido pela legislação
            brasileira de propriedade intelectual.
          </p>
          <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed">
            <li>
              É proibida a reprodução, distribuição ou modificação do conteúdo
              do portal sem autorização prévia;
            </li>
            <li>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2 text-slate-600 leading-relaxed">
            <li>
              ...
              interrupções para manutenção ou por motivos de força maior;
            </li>
            <li>
        ...
        <section className="mb-8">
          ...
          <p className="text-slate-600 leading-relaxed">
            ...
            disponibilidade ininterrupta. Recomenda-se que o usuário não
        ...
        <section className="mb-8">
          ...
          <p className="text-slate-600 leading-relaxed">
            ...
            dirimir quaisquer questões oriundas da utilização deste portal,
