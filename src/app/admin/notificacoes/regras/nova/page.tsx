  ...
  return (
    <section>
      <div className="mx-auto max-w-3xl mb-4 sm:mb-6">
        ...
        <h1 className="text-xl sm:text-2xl font-bold text-slate-900">Nova Regra Automática</h1>
        <p className="text-xs sm:text-sm text-slate-600 mt-1">
          A regra é criada <strong>desativada</strong>. Você pode revisar e ativar depois.
        </p>
      </div>

      <RuleForm editais={editais} triggers={triggers} />
    </section>
  )
}
