...
import { HistoricoProcesso } from '@client/components/inscricao/historico-processo'
import { viewNotaTotal } from '@/lib/services/avaliacao-view'
import { podeAvaliar, podeHabilitar, mensagemForaDaFase } from '@shared/edital/fase'
