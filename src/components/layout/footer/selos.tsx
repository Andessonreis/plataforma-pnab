    ...
    <div className="min-w-0 lg:col-span-2">
      ...
      <div className="flex flex-wrap gap-2 sm:flex-col sm:gap-3">
        {SELOS.map((selo) => (
          <div
            key={selo.titulo}
            className="flex w-full min-w-0 items-center gap-2.5 rounded-md border border-papel-100/10 bg-papel-100/[0.04] px-3 py-2.5 transition-colors hover:bg-papel-100/[0.08] sm:px-3.5 sm:py-3"
          >
            ...
            <div className="min-w-0">
              <p className="truncate text-xs font-semibold text-papel-100">{selo.titulo}</p>
              <p className="mt-0.5 hidden truncate text-[10px] text-papel-200/50 sm:block">
                {selo.descricao}
              </p>
            </div>
          </div>
