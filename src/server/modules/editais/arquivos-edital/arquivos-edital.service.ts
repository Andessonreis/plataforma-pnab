...
import { EditalNaoEncontradoError } from '@server/modules/editais/editais/editais.errors'
import type { ArquivoEditalUploadMeta } from '@shared/schemas/arquivos-edital.schema'
import { arquivosEditalRepository } from './arquivos-edital.repository'
import { ArquivoEditalNaoEncontradoError, ArquivoInvalidoError } from './arquivos-edital.errors'
